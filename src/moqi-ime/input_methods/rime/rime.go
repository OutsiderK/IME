...
type IME struct {
	...
	*imecore.TextServiceBase
	...
	ghostReady                   bool
	ghostVisible                 bool
	ghostRevealRequested         bool
	ghostCandidates              []string
	ghostCandidateIndex          int
	ghostConsumeKeyUpCode        int
	ghostContext                 string
	...
	ghostPreeditBeforeCommit     string
...
func (ime *IME) filterKeyUp(req *imecore.Request, resp *imecore.Response) *imecore.Response {
	if ime.handleGhostKeyUpFilter(req, resp) {
		return resp
	}
...
func (ime *IME) onKeyDown(req *imecore.Request, resp *imecore.Response) *imecore.Response {
	compositionBeforeCommit := ime.ghostPreeditBeforeCommit
	ime.ghostPreeditBeforeCommit = ""
	defer ime.scheduleGhostCompletionAfterCommit(req, resp, compositionBeforeCommit)
	if ime.handleGhostKeyDown(req, resp) {
		return resp
	}
...
func (ime *IME) onKeyUp(req *imecore.Request, resp *imecore.Response) *imecore.Response {
	defer ime.scheduleGhostCompletion(req)
	if ime.handleGhostKeyUp(req, resp) {
		return resp
	}
